...
savePath = 'C:\Users\munib\Documents\Economo-Lab\code\taggingAnalysis\results\NullPotent\20240613_202626';
...
h = histogram(align.nontag,30,'edgecolor','none','Normalization','probability','Visible','off');
bars = h.Values;
binedges = h.BinEdges;
...
scatter(align.tag,0.25*ones(size(align.tag)), 50, 'o', 'MarkerEdgeColor','w','MarkerFaceColor','k')
ln = line([0 0], ax.YLim);
ln.LineStyle = '--';
ln.Color = 'k';
ln.LineWidth = 2;
