...
addpath(genpath('C:\Users\munib\matnwb'))

% example nwb file to read
datapth = 'C:\Users\munib\Documents\Economo-Lab\data\hidehiko';
% datafn = 'sub-SC009_ses-SC009-112118_ecephys+ogen.nwb';
% datafn = 'sub-SC009_ses-SC009-112418_ecephys+ogen.nwb';
datafn = 'sub-SC009_ses-SC009-112618_ecephys+ogen.nwb';
nwb = nwbRead(fullfile(datapth,datafn));
