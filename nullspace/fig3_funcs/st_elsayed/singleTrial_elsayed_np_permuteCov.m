function rez = singleTrial_elsayed_np_permuteCov(input_data,obj,me,params,cond2use, cond2proj, nullalltime, onlyAW, delayOnly, responseOnly, varargin)
...
% randomly permute covNull
permix = randperm(N.dims(3));
% rez.covNull = rez.covNull(permix,permix);
rez.covPotent = rez.covPotent(permix,permix);
